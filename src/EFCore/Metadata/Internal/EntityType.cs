...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class EntityType : TypeBase, IMutableEntityType, IConventionEntityType
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual bool IsAutomaticallyCreatedAssociationEntityType
        ...
        /// </summary>
        [DebuggerStepThrough]
        IMutableIndex IMutableEntityType.FindIndex(string name) => FindIndex(name);
        ...
        /// </summary>
        [DebuggerStepThrough]
        IConventionIndex IConventionEntityType.FindIndex(string name) => FindIndex(name);
